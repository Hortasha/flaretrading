...
const getBalance = async(token, address, provider) => { 
    const web3 = new Web3(
    ...
    /*
    let xUSD = {
        YFLR: 1.446099675314888,
        YFIN: 0.0005232849018618995,
        FXRP: 4.79521613812075,
        FLTC: 0.007296248470797452,
        FDOGE: 49.22451438012038
      }

    let sign;
    if(token == pair[0].tokenA) {
        sign = pair[0].name.split('/')[0]
    } else {
        sign = pair[0].name.split('/')[1]
    }
    ...
    if(sign != 'xUSD') {
        fs.appendFile('log.txt', sign + ": " + res*(1/xUSD[sign]) + ". Address: " + address +  "\n", () => console.log("logging"));
    } else {
        fs.appendFile('log.txt', sign + ": " + res + ". Address: " + address +  "\n", () => console.log("logging"));
    }
    */
